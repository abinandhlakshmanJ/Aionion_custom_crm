...
def get_data(filters):
    ...
    query = (
        ...
        .select(
            ...
            USRec.aionion_client_code, USRec.client_name,
            USRec.contact_number, USRec.client_email,
            USRec.intended_investment, USRec.indian_investments,
            USRec.country_of_residence, USRec.employment_status,
            USRec.month, USRec.year, USRec.assigned_by, USRec.team,
            USRec.eligibility, USRec.us_status, USRec.progress,
            USRec.detailed_remarks, USRec.reminder_date,
            USRec.alternative_phone, USRec.current_country,
            USRec.alternative_email, USRec.alternate_email_id, USRec.emp_phone,
