...
const routes = [
  ...
  },
  {
    path: '/notifications',
    name: 'Notifications',
    component: () => import('@crm/pages/MobileNotification.vue'),
  },
  {
    path: '/dashboard',
    name: 'Dashboard',
  ...
  },
  {
    ...
    name: 'Leads',
    component: () => import('@crm/pages/Leads.vue'),
  },
  {
    path: '/leads/:leadId',
    name: 'Lead',
    component: () => import(`@crm/pages/${handleMobileView('Lead')}.vue`),
    props: true,
  },
  {
    alias: '/deals',
    ...
    name: 'Deals',
    component: () => import('@crm/pages/Deals.vue'),
  },
  {
    path: '/deals/:dealId',
    name: 'Deal',
    component: () => import(`@crm/pages/${handleMobileView('Deal')}.vue`),
    props: true,
  },
  {
    alias: '/notes',
    ...
    name: 'Notes',
    component: () => import('@crm/pages/Notes.vue'),
  },
  {
    alias: '/tasks',
    path: '/tasks/view/:viewType?',
    name: 'Tasks',
    component: () => import('@crm/pages/Tasks.vue'),
  },
  {
    alias: '/contacts',
    path: '/contacts/view/:viewType?',
    name: 'Contacts',
    component: () => import('@crm/pages/Contacts.vue'),
  },
  {
    path: '/contacts/:contactId',
    name: 'Contact',
    component: () => import(`@crm/pages/${handleMobileView('Contact')}.vue`),
    props: true,
  },
  {
    alias: '/organizations',
    ...
    name: 'Organizations',
    component: () => import('@crm/pages/Organizations.vue'),
  },
  {
    path: '/organizations/:organizationId',
    name: 'Organization',
    component: () => import(`@crm/pages/${handleMobileView('Organization')}.vue`),
    props: true,
  },
  {
    alias: '/call-logs',
    ...
    name: 'Call Logs',
    component: () => import('@crm/pages/CallLogs.vue'),
  },
  {
    path: '/data-import',
    name: 'DataImportList',
    component: () => import('@crm/pages/DataImport.vue'),
  },
  {
  ...
  },
  {
    path: '/welcome',
    name: 'Welcome',
    component: () => import('@crm/pages/Welcome.vue'),
  },
  {
    path: '/onboarding',
    name: 'Onboarding',
    component: () => import('@crm/pages/PersonaForm.vue'),
  },
  {
    path: '/:invalidpath',
    name: 'Invalid Page',
    component: () => import('@crm/pages/InvalidPage.vue'),
  },
  {
    path: '/not-permitted',
    name: 'Not Permitted',
    component: () => import('@crm/pages/NotPermitted.vue'),
  },
]
...
let router = createRouter({
  history: createWebHistory('/aionion_crm'),
  routes,
})
...
router.beforeEach(async (to, from, next) => {
  ...
  const { isLoggedIn, user } = sessionStore(pinia)
  const { users, isCrmUser, isAdmin } = usersStore(pinia)
  ...
  if (isLoggedIn && to.name !== 'Not Permitted' && !isCrmUser()) {
    ...
    const { views, getDefaultView } = viewsStore(pinia)
    await views.promise
    ...
    window.location.href = '/login?redirect-to=/aionion_crm'
    ...
    const { views, standardViews, getDefaultView } = viewsStore(pinia)
    await views.promise
