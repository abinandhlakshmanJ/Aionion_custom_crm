<template>
  <div class="flex flex-col h-full overflow-hidden">
    ...
    <div class="w-full flex-1 flex flex-col overflow-y-scroll">
      <DashboardGrid
...
import AddChartModal from '@crm/components/Dashboard/AddChartModal.vue'
import LucideRefreshCcw from '~icons/lucide/refresh-ccw'
import LucideUndo2 from '~icons/lucide/undo-2'
import LucidePenLine from '~icons/lucide/pen-line'
import DashboardGrid from '@/components/Dashboard/DashboardGrid.vue'
import UserAvatar from '@crm/components/UserAvatar.vue'
import ViewBreadcrumbs from '@crm/components/ViewBreadcrumbs.vue'
import LayoutHeader from '@crm/components/LayoutHeader.vue'
import Link from '@crm/components/Controls/Link.vue'
import { usersStore } from '@crm/stores/users'
import { copy } from '@crm/utils'
import { getLastXDays, formatter, formatRange } from '@crm/utils/dashboard'
import {
  usePageMeta,
  createResource,
  DateRangePicker,
...
const dashboardItems = createResource({
  ...
  auto: true,
  onSuccess(data) {
    console.log('[DEBUG] dashboardItems onSuccess data:', data)
  },
  onError(err) {
    console.error('[DEBUG] dashboardItems onError:', err)
  }
})
